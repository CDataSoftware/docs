...
description: "This page outlines the steps to connect SAP Analytics Cloud to Connect AI using the [OData](/ja/OData-Dashboard) protocol. This requires the use of workspaces. See the [Workspaces](/ja/Workspaces) documentation for more information."
---
...
- Create a [Workspace](/ja/Workspaces). Later, you will use the **OData Service URL** on that page (*https://cloud.cdata.com/api/odata/{workspace\_name}*) with the relevant workspace name to establish the connection.
...
- **Password**—enter the PAT you generated on the [Settings](/ja/Settings#access-tokens) page.
<Frame>
