...
Before you can configure and use Gemini with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/Sources-Embedded) for more information.
