...
While you create scheduled queries in the Data Explorer, you manage them in the [**Jobs**](/ja/Jobs) page.

The **Jobs** page contains a list of scheduled query jobs to run.

<Frame>
  <img src="/ja/images/scheduled_queries_jobs.png" alt="Scheduled queries jobs" />
</Frame>
...
On the Jobs page, click **+Add Job** > **Scheduled Query**. This launches the Data Explorer.
	<Frame>![](/ja/images/add_job_scheduled_query.png)</Frame>
</Step>
<Step>
...
<Steps>
<Step>
In Data Explorer, use the Query Builder or SQL Editor to build your query. See [Query Builder](/ja/QueryBuilder) for detailed steps.
</Step>
<Step>
When you have finished creating and executing your query, click **Save** > **Save as Scheduled Query**.
	<Frame>
	  <img src="/ja/images/scheduled_queries_save_as.png" alt="Scheduled queries save as" />
	</Frame>
...
Enter the **Destination Table** name for table to be created.
	<Frame>
	  <img src="/ja/images/scheduled_queries_schedule.png" alt="Scheduled queries schedule" />
	</Frame>
</Step>
<Step>
...
The scheduled query now appears in the Jobs queue.
	<Frame>
	  <img src="/ja/images/scheduled_queries_jobs_queue.png" alt="Scheduled queries jobs queue" />
	</Frame>
</Step>
</Steps>
...
<Frame>
  <img src="/ja/images/scheduled_queries_edit_job.png" alt="Scheduled queries edit job" />
</Frame>
