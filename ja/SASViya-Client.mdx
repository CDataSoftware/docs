...
Click the **Connection Options** tab and enter the following details.
	...
	<Frame>![](./images/sas_visual_analytics_client_06.png)</Frame>
	<Frame>![](./images/sas_visual_analytics_client_07.png)</Frame>
...
Click the “+” to add a new tab and select **SAS program**.
	<Frame>![](./images/sas_visual_analytics_client_08.png)</Frame>
</Step>
<Step>
