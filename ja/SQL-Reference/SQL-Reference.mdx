...
description: "Connect AI supports a wide range of standard [DDL Commands](/ja/SQL-Reference/DDL), [SQL Commands](/ja/SQL-Reference/SQL-Commands), and [SQL Functions](/ja/SQL-Reference/SQL-Functions) for querying data sources. This page outlines the Connect AI data model, supported data types, and naming requirements."
---
