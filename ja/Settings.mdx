...
In the **User Profile** section, you can edit the first name and last name for the current user. Your user role appears in the **Role** text box, but it cannot be edited on this page. See [Users](/ja/Users) for more information about roles.
...
Personal access tokens (PATs) are used when you connect to your data through [REST API](/ja/REST-API), the [OData protocol](/ja/OData), or [Virtual SQL Server](/ja/SQL-Server). You can create and manage your PATs on this tab.
