...
<Note>
Before you can configure and use SnapLogic with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
</Note>
