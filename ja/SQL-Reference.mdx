...
description: "Connect AI supports a wide range of standard [DDL Commands](/ja/DDL), [SQL Commands](/ja/SQL-Commands), and [SQL Functions](/ja/SQL-Functions) for querying data sources. This page outlines the Connect AI data model, supported data types, and naming requirements."
---
