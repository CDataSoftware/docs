...
Enter the following settings for your connection for your source data.
	...
	<Frame>
	  <img src="./images/cdatasync_source_connection.png" alt="CData Sync source connection" />
	</Frame>
</Step>
<Step>
...
Enter the following settings for your connection for your destination data.
	...
	**Note:** For other destination connection configurations, see the [CData Sync documentation](https://cdn.cdata.com/help/ASK/sync/index.html).
	...
	<Frame>![](./images/cdatasync_dest_connection.png)</Frame>
</Step>
<Step>
...
In **Jobs**, click the new job you just created. In the **Task** tab, click **Add Tasks**.
	<Frame>
	  <img src="./images/cdatasync_addtasks.png" alt="CData Sync add tasks" />
	</Frame>
</Step>
<Step>
In the **Select Schema** dialog, select the schema and table you want to replicate.
	<Frame>
	  <img src="./images/cdatasync_selectschema.png" alt="CData Sync select schema" />
	</Frame>
</Step>
<Step>
The table is added as a task. Click **Run** to run the task.
	<Frame>
	  <img src="./images/cdatasync_runtask.png" alt="CData Sync run task" />
	</Frame>
</Step>
<Step>
The table is replicated to your destination.
	<Frame>
	  <img src="./images/cdatasync_replicated.png" alt="CData Sync replicated" />
	</Frame>
</Step>
</Steps>