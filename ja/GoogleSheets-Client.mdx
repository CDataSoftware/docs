...
**Connect AI Customers Only:** You can also import Workspaces and Derived Views. To create a workspace, follow the instructions in [Workspaces](/Workspaces). To create a derived view (administrators only), follow the instructions in [Create a Derived View](Data-Explorer#create-a-derived-view).
