...
- **Query users** can issue queries to established connections through the [Data Explorer](/ja/Data-Explorer) page and through [integration tools](/ja/Integrations). They cannot access administrative functions, including [Sources](/ja/Sources) and user management.
...
- The number of **user seats** that are available on your account and a **[Manage Subscription](/ja/Settings#billing)** link.
