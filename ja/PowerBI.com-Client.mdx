...
<Note>
Before you can configure and use PowerBI.com with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
</Note>
...
Please see [Power BI Desktop](/ja/PowerBIDesktop-Client) and follow the steps to connect to Connect AI and import your data. When you finish this process, save your report and continue with the steps below.
