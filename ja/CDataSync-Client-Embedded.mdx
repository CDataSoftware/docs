...
- Connect a data source to your Embedded Cloud account. See [Sources](/jp/Sources-Embedded) for more information.
- Generate an [OAuth JWT bearer token](/jp/API/Authentication-Embedded). Copy this down, as it acts as your password during authentication.
