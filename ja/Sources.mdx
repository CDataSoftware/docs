---
title: "Sources"
description: "The ***Sources*** page enables you to create and manage connections to your [data sources](/ja/Data-Sources)."
---
...
<Steps>
<Step>
Configure the connection according to the [instructions for the data source](/ja/Data-Sources). The instructions for setting up the connection appear in the right pane of the configuration page, in the **Documentation** tab.
</Step>
<Step>
Click **Save and Test**.
</Step>
