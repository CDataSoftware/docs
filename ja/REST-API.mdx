...
description: "Connect AI provides a full-featured API that allows any REST-compatible application or integration tool capable of creating HTTP requests to query data, perform batch query operations, and execute stored procedures across all data sources configured in your account. This API is based on a JSON-formatted API. All operations in the API are described relative to the Connect AI API's base URL:"
---
...
All requests to the Connect AI API must be properly authenticated using either OAuth or Basic Authentication. See [Authentication](/ja/Authentication) for details.
