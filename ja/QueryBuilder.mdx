...
Click **Save** to save the query as a derived view, a saved query, or a scheduled query. If you save as a derived view or saved query, a **Save** dialog appears.
	<Note>If you save the query as a scheduled query, an **Add Job** page appears. This is where you add details about the scheduled query job, such as how often it runs. See [Scheduled Queries](/ja/Scheduled-Queries) for details.
	For more information about derived views, see [Configuring Derived Views](/ja/Data-Explorer#configuring-derived-views). For more information about saved queries, see [Saving a Query](/ja/Data-Explorer#saving-a-query).</Note>
</Step>
<Step>
