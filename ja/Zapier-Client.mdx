---
title: "Zapier"
description: "This page outlines the steps to connect Zapier to Connect AI using the [OData](/ja/OData-Dashboard) protocol. This requires the use of workspaces. See the [Workspaces](/ja/Workspaces) documentation for more information."
---
