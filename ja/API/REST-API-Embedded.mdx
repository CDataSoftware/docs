...
All requests to the Embedded Cloud API must be properly authenticated using JSON Web Tokens (JWT). See [Authentication](/ja/API/Authentication-Embedded) for details.
