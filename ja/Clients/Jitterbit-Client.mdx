---
title: "Jitterbit"
description: "このページでは、[OData](/ja/API/OData-Dashboard) プロトコルを使用してJitterbit をConnect AI に接続する手順の概要を示します。これには、ワークスペースを使う必要があります。詳しくは、[Workspaces](/ja/Workspaces) ヘルプを参照してください。"
---
...
<Frame>
![](/ja/images/jitterbit_open_project.png)
</Frame>
</Step>
<Step>
...
<Frame>
![](/ja/images/jitterbit_configure_OData.png)
</Frame>
</Step>
<Step>
...
<Frame>
![](/ja/images/jitterbit_tables.png)
</Frame>
</Step>
<Step>
