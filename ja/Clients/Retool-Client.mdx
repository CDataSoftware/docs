...
<Frame>
  <img src="/ja/images/retool_client_endpoints_URL.png" alt="Retool client endpoints URL" />
</Frame>
</Step>
<Step>
Log in to Retool.
...
<Frame>
  <img src="/ja/images/retool_client_create_new.png" alt="Retool client create new" />
</Frame>
</Step>
<Step>
...
<Columns colls={2}>
<Frame>
  <img src="/ja/images/retool_client_openapi.png" alt="Retool client OpenAPI" />
</Frame>
</Columns>
</Step>
<Step>
...
<Frame>
  <img src="/ja/images/retool_client_openapi_config.png" alt="Retool client OpenAPI config" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/ja/images/retool_client_create_resource.png" alt="Retool client create resource" />
</Frame>
</Step>
<Step>
Select the new resource you created, and view the endpoints that are available.
<Frame>
  <img src="/ja/images/retool_client_endpoints.png" alt="Retool client endpoints" />
</Frame>
</Step>
<Step>
You can now build your app with the data.
<Frame>
  <img src="/ja/images/retool_client_create_app.png" alt="Retool client create app" />
</Frame>
</Step>
</Steps>
...
Under **Resources**, click **Connect a resource**.
	<Frame>![](/ja/images/retool_client_01.png)</Frame>
</Step>
<Step>
Enter “Microsoft SQL” in the search bar and click the resulting option.
	<Frame>![](/ja/images/retool_client_02.png)</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/ja/images/retool_client_03.png" alt="Retool client 03" />
</Frame>
</Step>
<Step>
