---
title: "ADO.NET"
description: "This page outlines the steps that are required to use the Microsoft ADO.NET data provider for Embedded Cloud."
---

## Prerequisites

Before you can configure and use ADO.NET with Embedded Cloud, you must first connect a data source to your Embedded Cloud account. See [Sources](/ja/Sources-Embedded) for more information.
...
Embedded Cloud uses OAuth JWT to establish a connection between the ADO.NET Provider and your account. 
