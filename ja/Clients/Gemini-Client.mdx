...
The Gemini screen appears as follows:
	<Frame>
	  <img src="/ja/images/gemini_client_homescreen.png" alt="Gemini client home screen" />
	</Frame>
</Step>
<Step>
...
Gemini returns a response to your prompt.
	<Frame>
	  <img src="/ja/images/gemini_client_prompt.png" alt="Gemini client prompt" />
	</Frame>
</Step>
</Steps>
...
In your web browser, open `127.0.0.1:5000`. The application looks like the following:
	<Frame>
	  <img src="/ja/images/gemini_client_ADK.png" alt="Gemini client ADK" />
	</Frame>
</Step>
<Step>
Enter a prompt in the **Type a Message** box. Gemini uses the Connect AI tools such as `getCatalogs`, `getSchemas`, and `getTables` to retrieve data from connected data sources.
	<Frame>
	  <img src="/ja/images/gemini_client_adkprompt.png" alt="Gemini client ADK prompt" />
	</Frame>
</Step>
</Steps>