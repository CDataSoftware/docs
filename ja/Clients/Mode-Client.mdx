...
On the **Discover** page of Mode, click **Connect a Database**.
	<Frame>
	  <img src="/ja/images/mode_client_connect_database.png" alt="Mode client connect database" />
	</Frame>
</Step>
<Step>
On the next screen, select **Microsoft SQL Server**.
	<Frame>
	  <img src="/ja/images/mode_client_sql_server.png" alt="Mode client SQL Server" />
	</Frame>
</Step>
<Step>
Enter the following Microsoft SQL Server settings.
	...
	<Frame>
	  <img src="/ja/images/mode_client_connection_credentials.png" alt="Mode client connection credentials" />
	</Frame>
</Step>
<Step>
...
After your connection succeeds, click **New Report**. The SQL query text editor appears.
	<Frame>
	  <img src="/ja/images/mode_client_create_report.png" alt="Mode client create report" />
	</Frame>
</Step>
<Step>
...
Click **+New chart** to create visualizations from the data.
	<Frame>
	  <img src="/ja/images/mode_client_create_chart.png" alt="Mode client create chart" />
	</Frame>
</Step>
</Steps>