...
<Step>
[Settings](/ja/Settings) ページでPersonal Access Token（PAT）を生成します。PAT をコピーし、認証時にパスワードとして使用します。
</Step>
</Steps>
...
Click **Start** within your IDE to start the MCP server. If the MCP server starts without error, it displays **Running**.
	<Frame>![](/ja/images/githubcopilot_client_config.png)</Frame>
</Step>
<Step>
Toggle **Chat** in the title bar to display the **Chat** pane on the right.
	<Frame>![](/ja/images/githubcopilot_client_chat.png)</Frame>
</Step>
<Step>
Click **Add Context** in the bottom of the **Chat** pane. In the search bar, select **Tools**. Then search for *CData*. Add **cdata-mcp All Tools**.
	<Frame>![](/ja/images/githubcopilot_client_tools.png)</Frame>
</Step>
</Steps>
...
<Frame>
![](/ja/images/githubcopilot_client_results.png)
</Frame>