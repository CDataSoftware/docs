---
title: "AWS Glue"
description: "This page outlines the steps to connect AWS Glue to your Embedded Cloud account."
---
...
Follow these steps to establish a connection from AWS Glue to Embedded Cloud:
...
GlueStudio opens in a new browser tab. Set the connection properties as follows:
	...
	- **Password**—enter the token you generated in the prerequisites.
...
After you create your connection to Embedded Cloud, you can use the connection to create a job. Follow these steps:
