...
Visit `http://localhost:3000/setup` to start Metabase and complete your setup.
	<Frame>
	  <img src="/ja/images/metabase_client_welcome.png" alt="Metabase client welcome" />
	</Frame>
</Step>
<Step>
...
Click **SQL Server**.
	<Frame>
	  <img src="/ja/images/metabase_client_add_data.png" alt="Metabase client add data" />
	</Frame>
</Step>
<Step>
Enter the following information:
	...
	<Frame>
	  <img src="/ja/images/metabase_client_add_data_2.png" alt="Metabase client add data 2" />
	</Frame>
...
In the Home screen, click **New** > **SQL Query**.
	<Frame>
	  <img src="/ja/images/metabase_client_sql_query.png" alt="Metabase client SQL query" />
	</Frame>
</Step>
<Step>
Select the database you just added.
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/metabase_client_select_database.png" alt="Metabase client select database" />
	</Frame>
	</Columns>
</Step>
<Step>
Create a SQL query for the data.
	<Frame>
	  <img src="/ja/images/metabase_client_query.png" alt="Metabase client query" />
	</Frame>
</Step>
<Step>
Click **Run query** to retrieve your data.
	<Frame>
	  <img src="/ja/images/metabase_client_query_results.png" alt="Metabase client query results" />
	</Frame>
</Step>
<Step>
