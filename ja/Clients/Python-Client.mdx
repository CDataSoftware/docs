...
Before you can configure and use Python with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
...
You can connect the Python client to a specific [workspace](/ja/Workspaces) as follows:
