...
<Frame>
  <img src="/ja/images/sheets_getaddon.png" alt="Sheets get addon" />
</Frame>
</Step>
<Step>
検索バーで**CData** と検索し、**CData Connect Spreadsheets** アドオンをクリックします。
<Frame>
  <img src="/ja/images/google_sheets_marketplace.png" alt="Google Sheets marketplace" />
</Frame>
</Step>
<Step>
...
**Execute** をクリックします。
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/sheets_querybuilder.png" alt="Sheets query builder" />
	</Frame>
	</Columns>
</Step>
<Step>
...
アップデートしたいスプレッドシートの隣にあるチェックボックスを選択します。
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/sheets_refresh.png" alt="Sheets refresh" />
	</Frame>
	</Columns>
</Step>
<Step>
...
<Columns cols={2}>
<Frame>
  <img src="/ja/images/sheets_autorefresh.png" alt="Sheets auto refresh" />
</Frame>
</Columns>
## データの更新
...
<Columns cols={2}>
<Frame>
  <img src="/ja/images/sheets_filter.png" alt="Sheets filter" />
</Frame>
</Columns>
...
<Columns cols={2}>
<Frame>
  <img src="/ja/images/sheets_sort.png" alt="Sheets sort" />
</Frame>
</Columns>
