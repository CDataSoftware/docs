...
From the SAP Analytics Cloud dashboard, open the navigation menu and click **Connections**.
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/sap_connections.png" alt="SAP connections" />
	</Frame>
	</Columns>
</Step>
<Step>
On the Connection page, click **Add Connection**.
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/sap_addconnection.png" alt="SAP add connection" />
	</Frame>
	</Columns>
</Step>
<Step>
...
Configure the connection:
	...
	<Frame>
	  <img src="/ja/images/sap_connectionfields.png" alt="SAP connection fields" />
	</Frame>
</Step>
<Step>
...
In the **Create New** section, click **From a Data Source**.
	<Frame>
	  <img src="/ja/images/sap_createnew.png" alt="SAP create new" />
	</Frame>
</Step>
<Step>
...
In the **Connection** drop-down menu, select the connection you created. If you are using the Modeler tab, select the **Create a new query** radio button.
	<Frame>
	  <img src="/ja/images/sap_selectsource.png" alt="SAP select source" />
	</Frame>
</Step>
<Step>
