...
Click the three dots to open the Dataset actions and select **New Dataset**.
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/adf_new_dataset.png" alt="ADF new dataset" />
	</Frame>
	</Columns>
</Step>
<Step>
...
Click **New** > **Dataset**.
    <Columns cols={3}>
	<Frame>
	  <img src="/ja/images/adf_client_new_dataset.png" alt="ADF client new dataset" />
	</Frame>
	</Columns>
...
In the search bar, enter *OData*.
	<Frame>
	  <img src="/ja/images/adf_client_odata.png" alt="ADF client OData" />
	</Frame>
...
Enter the following settings for OData:
	...
	- **Password**—select **Password** (not **Azure Key Vault**) and [Settings](/ja/Settings#access-tokens) ページで生成したPAT を入力します。
	<Frame>
	  <img src="/ja/images/adf_client_new_linked_service.png" alt="ADF client new linked service" />
	</Frame>
</Step>
<Step>
...
In the tab for your new dataset, select the path for the data you want to view.
	<Frame>
	  <img src="/ja/images/adf_client_preview_data.png" alt="ADF client preview data" />
	</Frame>
</Step>
<Step>
