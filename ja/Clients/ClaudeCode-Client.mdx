...
Before you can configure and use Claude Code with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
...
Type `claude`. A welcome screen appears:
    <Columns cols={2}>
	<Frame>
	  <img src="/ja/images/claudecode_client_welcome.png" alt="Claude Code client welcome" />
	</Frame>
	</Columns>
</Step>
<Step>
...
You can now interact with the MCP server:
	<Frame>
	  <img src="/ja/images/claudecode_client_prompt.png" alt="Claude Code client prompt" />
	</Frame>
</Step>
</Steps>