...
<Steps>
<Step>
In the **Workspaces** screen in Connect AI, select a workspace and download the OpenAPI specification for the workspace. See [OpenAPI](/ja/API/OpenAPI) for more information.
<Note>
...
<Frame>
![](/ja/images/sfl_externalservices.png)
</Frame>
</Step>
<Step>
...
<Frame>
![](/ja/images/sfl_externaloperations.png)
</Frame>
	The input parameters are appended to the URL, such as `$top`, `$filter`, and `$orderby`. See [API Operations](/ja/API/OpenAPI#api-operations) for a complete parameter reference. The input parameters are based on OData filtering.
...
<Frame>
![](/ja/images/sfl_reviewactions.png)
</Frame>
</Step>
<Step>
