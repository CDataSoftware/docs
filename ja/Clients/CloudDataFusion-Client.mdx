...
Before you can configure and use Cloud Data Fusion with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
...
Download and install the Connect AI JDBC driver.
	...
	b. Search for **JDBC** or **Cloud Data Fusion**.
...
Under **Driver**, click **Upload**.
	<Frame>
	  <img src="/ja/images/google_data_fusion_client_01.png" alt="Google Data Fusion client 01" />
	</Frame>
</Step>
<Step>
...
Enter the driver settings.
	...
	<Frame>
	  <img src="/ja/images/google_data_fusion_client_02.png" alt="Google Data Fusion client 02" />
	</Frame>
</Step>
<Step>
Click **Finish**.
...
Enter source configuration settings.
	...
	<Frame>
	  <img src="/ja/images/google_data_fusion_client_03.png" alt="Google Data Fusion client 03" />
	</Frame>
</Step>
<Step>
...
If the connection succeeds, you can manage the pipeline by editing it through the UI.
	<Frame>
	  <img src="/ja/images/google_data_fusion_client_04.png" alt="Google Data Fusion client 04" />
	</Frame>
</Step>
</Steps>
