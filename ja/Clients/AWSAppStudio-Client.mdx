...
<Frame>
  <img src="/ja/images/aws_appstudio_client_endpoints.png" alt="AWS App Studio client endpoints" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/ja/images/aws_appstudio_client_automation.png" alt="AWS App Studio client automation" />
</Frame>
</Step>
<Step>
In the **Properties** tab to the right of the application creation screen, select the OpenAPI connector you created.
<Frame>
  <img src="/ja/images/aws_appstudio_client_properties.png" alt="AWS App Studio client properties" />
</Frame>
</Step>
<Step>
