---
title: "ODBC"
description: "This page outlines the steps to use the ODBC Driver with Embedded Cloud."
---
...
- Connect a data source to your Embedded Cloud account. See [Sources](/ja/Sources-Embedded) for more information.
...
Embedded Cloud users can connect the ODBC client using OAuthJWT authentication. Set the **Auth Scheme** in your ODBC connection as **OAuthJWT**.
