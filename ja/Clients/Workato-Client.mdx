...
In your new project, click **Create** > **Connection**.
	<Frame>![](/ja/images/workato_client_create_connection.png)</Frame>
</Step>
<Step>
In the search bar, enter “SQL Server”. The **Connect to SQL Server** screen appears.
	<Frame>![](/ja/images/workato_client_connect_sql.png)</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/ja/images/workato_client_create_recipe.png" alt="Workato client create recipe" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/ja/images/workato_client_select_table.png" alt="Workato client select table" />
</Frame>
</Step>
<Step>
