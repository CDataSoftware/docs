---
title: "Mendix"
description: "このページでは、[OData](/ja/API/OData-Dashboard) プロトコルを使用してMendix をConnect AI に接続する手順の概要を示します。これには、ワークスペースを使う必要があります。詳しくは、[Workspaces](/ja/Workspaces) ヘルプを参照してください。"
---
