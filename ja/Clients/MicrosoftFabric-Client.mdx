...
Before you connect, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
...
<Frame>
  <img src="/ja/images/fabric_client_new_item.png" alt="Fabric Client New Item" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_choose_data.png" alt="Fabric Client Choose Data" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_sign_in.png" alt="Fabric Client Sign In" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_connections.png" alt="Fabric Client Connections" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_load_table.png" alt="Fabric Client Load Table" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_power_query.png" alt="Fabric Client Power Query" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_data_destination.png" alt="Fabric Client Data Destination" />
</Frame>
</Step>
<Step>
Select a destination target. You can overwrite an existing table or create a new destination table. Click **Next**.
<Frame>
  <img src="/ja/images/fabric_client_destination_target.png" alt="Fabric Client Destination Target" />
</Frame>
</Step>
<Step>
Map the data types for your destinations. Click **Save settings**.
<Frame>
  <img src="/ja/images/fabric_client_destination_settings.png" alt="Fabric Client Destination Settings" />
</Frame>
...
<Frame>
  <img src="/ja/images/fabric_client_query_editor.png" alt="Fabric Client Query Editor" />
</Frame>
</Step>
</Steps>
