...
以下の手順で、Act-On をConnect AI アカウントに接続します。
...
<Step>
検索フィールドに *Act-On* と入力し、データソース名をクリックします。
</Step>
<Step>
新しいコネクションの**Basic Settings** タブで、コネクション名を入力するかデフォルトの名前をそのまま使用します。
</Step>
<Step>
OAuth でセキュアに接続するには、**Sign in** をクリックします。これにより、Act-On のサインインページが新しいタブで開かれます。
</Step>
<Step>
Act-On アカウントにログインし、リクエストされた権限を設定します（該当する場合）。
</Step>
<Step>
Connect AI **Add Act-On Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とAct-On の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/OVM/ja/cloud/default.htm#default)を参照してください。