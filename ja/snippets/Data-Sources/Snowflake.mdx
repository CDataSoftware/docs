...
<Step>
(Optional) Enter the **External Token**. You must specify this if you want to connect to PingFederate without using a browser. For more information about the Proof Key and External Token, follow the steps [here](https://cdn.cdata.com/help/OWJ/jp/cloud/default.htm#RSBSnowflake_p_AuthScheme).
</Step>
<Step>
