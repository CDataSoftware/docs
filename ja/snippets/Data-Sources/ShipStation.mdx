...
以下の手順で、ShipStation をConnect AI アカウントに接続します。
...
<Step>
検索フィールドに *ShipStation* と入力し、データソース名をクリックします。
</Step>
<Step>
...
<Step>
Connect AI **Add ShipStation Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とShipStation の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/HSM/ja/cloud/default.htm#default)を参照してください。