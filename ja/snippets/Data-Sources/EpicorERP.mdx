...
<Step>
Connect AI **Add Epicor Kinetic Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とEpicor Kinetic の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/UEM/ja/cloud/default.htm#default)を参照してください。
