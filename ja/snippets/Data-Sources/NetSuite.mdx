...
For a detailed discussion about the differences between SuiteTalk and SuiteQL, see the [NetSuite driver documentation](https://cdn.cdata.com/help/DNK/jp/cloud/default.htm#pg_suiteql).
...
Add additional permissions.
	...
	<Warning>
	**Important: See [Permission Configurations](https://cdn.cdata.com/help/DNK/jp/cloud/default.htm#pg_permissions) in the NetSuite driver documentation for additional permissions that may be needed.**
	</Warning>
</Step>
<Step>
...
For the **Schema** field, select either SuiteQL or SuiteTalk.
	<Note>
	**Note:** CData recommends SuiteQL for most use cases. Click [here](https://cdn.cdata.com/help/DNK/jp/cloud/default.htm#pg_suiteql) for information on the differences between SuiteQL and SuiteTalk.
	</Note>
</Step>
<Step>
...
Connect AI とNetSuite の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/DNK/jp/cloud/default.htm#default)を参照してください。