...
<Columns cols={2}>
<Frame>
![](/ja/images/quickbooks_common_queries.png)
</Frame>
</Columns>
...
Connect AI とQuickBooks Online の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/RNM/ja/cloud/default.htm#default)を参照してください。