...
<Step>
Connect AI **Add Google Spanner Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とGoogle Spanner の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/OGM/ja/cloud/default.htm#default)を参照してください。