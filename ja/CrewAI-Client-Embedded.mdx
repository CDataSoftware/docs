...
- Connect a data source to your Connect AI account. See [Sources](/ja/Sources-Embedded) for more information.
...
<Step>
Copy and paste the content below. Instead of MCP_USERNAME and MCP_PASSWORD, use the OAuth JWT token from the prerequisites to authenticate. Your OpenAI API key can be found at [https://platform.openai.com/](https://platform.openai.com/).
...
<Frame>
  <img src="./images/crewai_client_output.png" alt="CrewAI Client Output" />
</Frame>
</Step>
</Steps>