...
<Step>
Copy and paste the content below. For Embedded Cloud, you do not need the `MCP_USERNAME` and `MCP_PASSWORD`. Use the OAuth JWT token from the prerequisites to authenticate. Your OpenAI API key can be found at [https://platform.openai.com/](https://platform.openai.com/).
