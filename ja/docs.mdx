...
For more information about these key features, see [Technology](/ja/Technology).

## Get Started

For a high-level overview about setting up and using Connect AI, see [Quick Start Guide](/ja/Quick-Start-Guide).

For more detailed information about the features of Connect AI, see the documentation outlined below:

- [Dashboard](/ja/Dashboard)—Information about navigating Connect AI and accessing features.
- [Sources](/ja/Data-Sources)—Steps for connecting data sources to Connect AI to make your data available for use.
- [Integrations](/ja/Integrations)—Steps for connecting integration tools to Connect AI to access data from your data sources.
- [API](/ja/API)—Information about connecting to data via the REST API, OData, and OpenAPI protocols.
- [Virtual Databases](/ja/Virtual-Databases)—Information about the virtual database feature of Connect AI, including SQL Server.
- [SQL Reference](/ja/SQL-Reference)—List of supported SQL syntax and code examples.
