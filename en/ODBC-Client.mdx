...
Before you can configure and use ODBC with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/en/Sources) for more information.
...
To connect the ODBC client to a specific [workspace](/en/Workspaces), you specify the workspace name in the **Advanced** tab of the ODBC driver for Connect AI.
