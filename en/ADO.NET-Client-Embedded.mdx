...
<Note>
Before you can configure and use ADO.NET with Embedded Cloud, you must first connect a data source to your Embedded Cloud account. See [Sources](/en/Sources-Embedded) for more information.
</Note>
...
Embedded Cloud uses OAuth JWT to establish a connection between the ADO.NET Provider and your account. The steps below provide an example of configuring the ADO.NET Provider in Visual Studio 2022:
<Steps>
<Step>
