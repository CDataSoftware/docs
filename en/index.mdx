...
<div className="py-8 px-4 max-w-[1200px] mx-auto">
  <div className="text-center mb-16">
    ...
    <div className="flex gap-4 justify-center flex-wrap">
      <a  href="https://cloud-login.cdata.com/u/signup"  className="inline-block px-6 py-3 bg-[#002660] text-white rounded-md font-medium hover:opacity-90">
        Sign up
      </a>
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
    <div className='dark:bg-[#1E1E1E] bg-white border dark:border-gray-700 border-[#e5e7eb] p-8 rounded-xl shadow-sm'>
      <div className="mb-5">
        <Icon icon="grid" size={48} color="#002660" />
      </div>
      ...
      <a href="/en/Data-Sources/Salesforce" className="text-[#002660] no-underline font-medium text-[0.9375rem] inline-block">Data Sources →</a>
    </div>

    <div className='dark:bg-[#1E1E1E] bg-white border dark:border-gray-700 border-[#e5e7eb] p-8 rounded-xl shadow-sm'>
      <div className="mb-5">
        <Icon icon="shield-user" size={48} color="#002660" />
      </div>
      <h3 className='dark:text-[#ccc] text-[#252525] text-xl font-bold mb-3'>
        Enterprise controls
      </h3>
    ...
    <div className='dark:bg-[#1E1E1E] bg-white border dark:border-gray-700 border-[#e5e7eb] p-8 rounded-xl shadow-sm'>
      <div className="mb-5">
        <Icon icon="database" size={48} color="#002660" />
      </div>
      <h3 className='dark:text-[#ccc] text-[#252525] text-xl font-bold mb-3'>
        APIs
      </h3>
      ...
      <a href="/en/API/API" className="text-[#002660] no-underline font-medium text-[0.9375rem] inline-block">API Reference →</a>
    </div>
  ...
  <div className="flex flex-col lg:flex-row gap-12 mb-16 items-center">
    ...
    <div className='lg:w-1/2 dark:text-white text-black'>
      ...
      <p className="dark:text-[#aaa] text-[#333]" style={{ fontSize: '1.125rem', lineHeight: '1.6', marginBottom: '2rem' }}>
       ...
       <a href="/en/Quick-Start-Guide" className="inline-flex items-center gap-2 px-6 py-3 bg-[#002660] text-white rounded-md font-medium hover:opacity-90">
...
```
    ...
    <div className='lg:w-1/2' style={{ padding: '2rem', borderRadius: '1rem' }}>
      ...
      <a href="/en/API/API" className="inline-block px-6 py-3 bg-[#002660] text-white border rounded-md font-medium hover:opacity-90">
         <Icon icon="book" size={16} color="white"/> Documentation
      </a>
    </div>
