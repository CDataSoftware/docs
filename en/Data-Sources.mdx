...
<Frame>
  <img src="/en/images/sources.png" alt="Data sources page showing available connections" />
</Frame>
...
On the **Advanced Settings** tab for each connection, there is a setting in the **Logging** section labelled **Verbosity**. This value determines how much information Connect AI includes in the logs for that data source on the [Logs](/en/Logs) page.
