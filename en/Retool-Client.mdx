...
<Steps>
<Step>
In **Workspaces** in Connect AI, select a workspace and copy the OpenAPI URL for the workspace. Keep the default options. See [OpenAPI](/en/OpenAPI) for more information.
<Frame>
