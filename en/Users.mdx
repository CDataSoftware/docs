...
- **Query users** can authenticate to a connection with their own credentials, as long as the user and connection meet the following criteria:
  ...
  - The Administrator grants the user permission to use the connection.
  - The Administrator selects **User Credentials**, rather than **Shared Credentials**, for the connection. 
  
  The query user can also issue queries to established connections through the [Data Explorer](/en/Data-Explorer) page and through [integration tools](/en/Integrations).
...
- The number of **user seats** that are available on your account and a **[Manage Subscription](/en/Settings#billing)** link.
- A row for every user on your account:
	...
	<Frame>
	  <img src="/en/images/users.png" alt="Users list" />
	</Frame>
...
Enter the email address of the user that you want to invite. To send multiple invitations at the same time, add a space between each email address.
	<Frame>
	  <img src="/en/images/user_invite.png" alt="Invite users" />
	</Frame>
</Step>
<Step>
...
Enter the account name and the invite code from the invitation email. Then, click **Complete Sign Up**.
	<Frame>
	  <img src="/en/images/users_signup.png" alt="User signup" />
	</Frame>
</Step>
</Steps>
...
<Frame>
  <img src="/en/images/user_pending.png" alt="Pending user" />
</Frame>
...
<Frame>
  <img src="/en/images/edit_user.png" alt="Edit user" />
</Frame>
