...
- **Query users** can issue queries to established connections through the [Data Explorer](/en/Data-Explorer) page and through [integration tools](/en/Integrations). They cannot access administrative functions, including [Sources](/en/Sources) and user management.
