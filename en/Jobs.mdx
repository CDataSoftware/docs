...
description: "The ***Jobs*** page enables you to manage and run various Connect AI jobs. From this page, you can manage either [Caching](/en/Caching) or [Scheduled Queries](/en/Scheduled-Queries)."
---

<Frame>
  <img src="/en/images/jobs.png" alt="Jobs" />
</Frame>
...
<Note>
Note that when you enable caching of data, Connect AI runs database queries against the *cached* data, not the live data. The cached data is stored in a PostgreSQL database, which you must set up before using the caching feature. You can manage the cache connection by clicking **Manage Cache Connection** on the Jobs page. See [Caching](/en/Caching) for details.
</Note>
