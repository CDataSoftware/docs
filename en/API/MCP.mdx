...
title: "MCP"
sidebarTitle: "MCP"
description: "Connect AI supports connectivity to the Model Context Protocol (MCP), the open-source standard for connecting AI applications to external systems. It was developed by Anthropic to bridge the gap between structured data and large language models (LLMs). MCP can be used from any client integration that supports it, such as [Claude](/en/Claude-Client), [Microsoft Copilot Studio](/en/MicrosoftCopilot-Client), and [n8n](/en/N8N-Client). See [AI Tools](/en/AITools) for a complete list of AI integrations."
---
