...
All requests to the Connect AI API must be properly authenticated using JSON Web Tokens (JWT). See [Authentication](/en/API/Authentication-Embedded) for details.
