...
title: "MCP"
sidebarTitle: "MCP"
description: "Embedded Cloud supports connectivity to the Model Context Protocol (MCP), the open-source standard for connecting AI applications to external systems. It was developed by Anthropic to bridge the gap between structured data and large language models (LLMs). MCP can be used from any client integration that supports it, such as [Claude Code](/en/Clients/ClaudeCode-Client-Embedded), [Microsoft Copilot Studio](/en/Clients/MicrosoftCopilot-Client-Embedded), and [Gemini](/en/Clients/Gemini-Client-Embedded). See [AI Tools](/en/Clients/AITools-Embedded) for a complete list of AI integrations for Embedded Cloud."
---
...
Embedded Cloud supports OAuth JWT bearer token authentication. See [Authentication](/en/API/Authentication-Embedded) for details.
