...
<Step>
After saving the connection, click **Tables** to move on to creating [Tables](/en/Data-Sources/APICreateTable).
</Step>
</Steps>
...
After creating an API connection, proceed to creating [Tables](/en/Data-Sources/APICreateTable).
