...
In general, performance is best in [SuiteAnalytics](/en/Data-Sources/NetSuiteSuiteAnalytics). Connect AI uses NetSuite's native SuiteAnalytics driver. We recommend using it if you have access to it. Note that SuiteAnalytics is not supported by the NetSuite drivers.
