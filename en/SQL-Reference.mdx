...
description: "Connect AI supports a wide range of standard [DDL Commands](/en/DDL), [SQL Commands](/en/SQL-Commands), and [SQL Functions](/en/SQL-Functions) for querying data sources. This page outlines the Connect AI data model, supported data types, and naming requirements."
---
