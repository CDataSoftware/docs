...
<Frame>
  <img src="/en/images/scheduled_queries_jobs.png" alt="Scheduled queries jobs" />
</Frame>
...
On the Jobs page, click **+Add Job** > **Scheduled Query**. This launches the Data Explorer.
	<Frame>![](/en/images/add_job_scheduled_query.png)</Frame>
</Step>
<Step>
...
When you have finished creating and executing your query, click **Save** > **Save as Scheduled Query**.
	<Frame>
	  <img src="/en/images/scheduled_queries_save_as.png" alt="Scheduled queries save as" />
	</Frame>
...
Enter the **Destination Table** name for table to be created.
	<Frame>
	  <img src="/en/images/scheduled_queries_schedule.png" alt="Scheduled queries schedule" />
	</Frame>
</Step>
<Step>
...
The scheduled query now appears in the Jobs queue.
	<Frame>
	  <img src="/en/images/scheduled_queries_jobs_queue.png" alt="Scheduled queries jobs queue" />
	</Frame>
</Step>
</Steps>
...
<Frame>
  <img src="/en/images/scheduled_queries_edit_job.png" alt="Scheduled queries edit job" />
</Frame>
