...
- For the Password, enter a Personal Access Token (PAT) that you generate on the [Settings](/en/Settings#access-tokens) page.
...
- [Qlik Sense Cloud](/en/QlikSenseCloud-Client)
