...
<Frame>
  <img src="/en/images/access_settings.png" alt="Access settings" />
</Frame>
...
<Frame>
  <img src="/en/images/settings_tabs.png" alt="Settings tabs" />
</Frame>
...
<Frame>
  <img src="/en/images/settings_profile.png" alt="Settings profile" />
</Frame>

In the **User Profile** section, you can edit the first name and last name for the current user. Your user role appears in the **Role** text box, but it cannot be edited on this page. See [Users](/en/Users) for more information about roles.
...
<Frame>
  <img src="/en/images/settings_account.png" alt="Settings account" />
</Frame>
...
Personal access tokens (PATs) are used when you connect to your data through [REST API](/en/API/REST-API), the [OData protocol](/en/Data-Sources/OData), or [Virtual SQL Server](/en/SQL-Server). You can create and manage your PATs on this tab.

<Frame>
  <img src="/en/images/settings_accesstokens.png" alt="Access tokens" />
</Frame>
...
Click the copy icon in that dialog to copy the PAT to your clipboard. The icon is to the right of the token field.
	...
	<Frame>
	  <img src="/en/images/pat_created.png" alt="PAT created" />
	</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/pat_regen.png" alt="Regenerate PAT" />
</Frame>
...
<Frame>
  <img src="/en/images/pat_delete.png" alt="Delete PAT" />
</Frame>
...
<Frame>
  <img src="/en/images/settings_billing.png" alt="Settings billing" />
</Frame>
