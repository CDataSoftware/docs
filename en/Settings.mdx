...
Personal access tokens (PATs) are used when you connect to your data through [REST API](/en/API/REST-API), the [OData protocol](/en/OData), or [Virtual SQL Server](/en/SQL-Server). You can create and manage your PATs on this tab.
