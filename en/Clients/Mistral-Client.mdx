...
Before you can configure and use Mistral Le Chat with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/en/Sources) for more information.
...
<Frame>
  <img src="/en/images/mistral_client_connectors.png" alt="Mistral Connectors" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/mistral_client_mcp.png" alt="Mistral MCP" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/mistral_client_newconnector.png" alt="Mistral New Connector" />
</Frame>
</Step>
<Step>
In **Chat**, click the enable tools icon and ensure that your new connector is selected.
<Frame>
  <img src="/en/images/mistral_client_tools.png" alt="Mistral Tools" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/mistral_client_catalogs.png" alt="Mistral Catalogs" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/mistral_client_prompt.png" alt="Mistral Prompt" />
</Frame>
</Step>
</Steps>
