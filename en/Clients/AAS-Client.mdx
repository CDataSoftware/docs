...
<Frame>
  <img src="/en/images/azureanalysis_configurenewproject.png" alt="Azure Analysis Configure New Project" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_tmd.png" alt="Azure Analysis TMD" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/azureanalysis_start.png" alt="Azure Analysis Start" />
</Frame>
</Step>
</Steps>
...
<Frame>
  <img src="/en/images/azureanalysis_import.png" alt="Azure Analysis Import" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_ssdb.png" alt="Azure Analysis SSDB" />
</Frame>
</Step>
<Step>
In the **Server** field, enter the Virtual SQL Server endpoint and port separated by a comma: *tds.cdata.com*,*14333*.
<Frame>
  <img src="/en/images/azureanalysis_enterdb.png" alt="Azure Analysis Enter DB" />
</Frame>
</Step>
<Step>
...
- **Password**—enter the PAT you generated on the [Settings](/en/Settings#access-tokens) page.
<Frame>
  <img src="/en/images/azureanalysis_entercredentials.png" alt="Azure Analysis Enter Credentials" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_navigator.png" alt="Azure Analysis Navigator" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_tableselect.png" alt="Azure Analysis Table Select" />
</Frame>  
</Step>
</Steps>
...
<Frame>
  <img src="/en/images/azureanalysis_solution.png" alt="Azure Analysis Solution" />
</Frame>
</Step>
<Step>
...
- Connect a data source to your Connect AI account. See [Sources](/en/Sources) for more information.
- Create a [Workspace](/en/Workspaces). Later, you will use the **OData Service URL** on that page (*https://cloud.cdata.com/api/odata/{workspace\_name}*) with the relevant workspace name to establish the connection.
- Generate a Personal Access Token (PAT) on the [Settings](/en/Settings#access-tokens) page. Copy this down, as it acts as your password during authentication.
...
<Frame>
  <img src="/en/images/azureanalysis_newdatasource.png" alt="Azure Analysis New Data Source" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_odata_feed.png" alt="Azure Analysis OData Feed" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_odata_url.png" alt="Azure Analysis OData URL" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_odata_credentials.png" alt="Azure Analysis OData Credentials" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_odata_load.png" alt="Azure Analysis OData Load" />
</Frame>
...
<Frame>
  <img src="/en/images/azureanalysis_odata_navigator.png" alt="Azure Analysis OData Navigator" />
</Frame>
</Step>
</Steps>
