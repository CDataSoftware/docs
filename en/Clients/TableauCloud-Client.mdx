...
- Connect a data source to your Connect AI account. See [Connections](/en/Sources) for more information.
...
- If you want to connect to a workspace rather than a data source, first [Add a workspace](/en/Workspaces#add-a-workspace) to Workspaces.
...
<Frame>
  <img src="/en/images/tableau_cloud_newconnection.png" alt="Tableau Cloud New Connection" />
</Frame>
</Step>
<Step>
On the **Connect to Data** dialog, select the **Connectors** tab. In the connectors list, select **Microsoft SQL Server**.
<Frame>
  <img src="/en/images/tableau_cloud_selectsource.png" alt="Tableau Cloud Select Source" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/en/images/tableau_cloud_editconnection.png" alt="Tableau Cloud Edit Connection" />
</Frame>
</Step>
<Step>
...
To connect Tableau Cloud to a specific [workspace](/en/Workspaces) in Connect AI, you specify the workspace name after the Connect AI username in the format of `[your_email_address]@[workspace_name]`:
<Frame>
  <img src="/en/images/tableau_cloud_workspace.png" alt="Tableau Cloud Workspace" />
</Frame>
...
<Frame>
  <img src="/en/images/tableau_cloud_endpoints.png" alt="Tableau Cloud Endpoints" />
</Frame>
