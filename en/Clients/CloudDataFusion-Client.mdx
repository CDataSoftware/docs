...
Before you can configure and use Cloud Data Fusion with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/en/Sources) for more information.
