---
title: "Zapier"
description: "This page outlines the steps to connect Zapier to Connect AI using the [OData](/en/API/OData-Dashboard) protocol. This requires the use of workspaces. See the [Workspaces](/en/Workspaces) documentation for more information."
---
...
<Frame>
![](/en/images/zapier_client_01.png)
</Frame>
</Step>
<Step>
Under Event, select **Retrieve Poll**.
<Frame>
![](/en/images/zapier_client_02.png)
</Frame>
</Step>
<Step>
