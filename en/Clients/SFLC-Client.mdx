...
description: "This page outlines the steps to connect Salesforce Lightning Connect to Connect AI using the [OData](/en/API/OData-Dashboard) protocol. This requires the use of workspaces. See the [Workspaces](/en/Workspaces) documentation for more information."
---
...
<Frame>
![](/en/images/sfl_externalsources.png)
</Frame>
</Step>
<Step>
Click **New External Data Source** at the top of the table.
<Frame>
![](/en/images/sfl_newsource.png)
</Frame>
</Step>
<Step>
...
<Frame>
![](/en/images/sfl_connectiondetails.png)
</Frame>
</Step>
<Step>
