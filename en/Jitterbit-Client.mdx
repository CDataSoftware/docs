---
title: "Jitterbit"
description: "This page outlines the steps to connect Jitterbit to Connect AI using the [OData](/en/OData-Dashboard) protocol. This requires the use of workspaces. See the [Workspaces](/en/Workspaces) documentation for more information."
---
