...
In order to connect from Node.js to Embedded Cloud via the SQL Server interface, you need the following information:
...
- **Password**—enter the password you generated in the prerequisites.
...
- Update `password` with the password you generated in the prerequisites.
...
var config = {
   ...
   password: 'OAUTH_JWT_TOKEN', //your JWT token from the prerequisites   
   options: {
      encrypt: true,
