...
For more information about these key features, see [Technology](/en/Technology).

## Get Started

For a high-level overview about setting up and using Connect AI, see [Quick Start Guide](/en/Quick-Start-Guide).

For more detailed information about the features of Connect AI, see the documentation outlined below:

- [Dashboard](/en/Dashboard)—Information about navigating Connect AI and accessing features.
- [Sources](/en/Sources)—Steps for connecting data sources to Connect AI to make your data available for use.
- [Integrations](/en/Integrations)—Steps for connecting integration tools to Connect AI to access data from your data sources.
- [API](/en/API/API)—Information about connecting to data via the REST API, OData, and OpenAPI protocols.
- [Virtual Databases](/en/Virtual-Databases)—Information about the virtual database feature of Connect AI, including SQL Server.
- [SQL Reference](/en/SQL-Reference/SQL-Reference)—List of supported SQL syntax and code examples.
