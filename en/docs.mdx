...
- [Sources](/en/Data-Sources)—Steps for connecting data sources to Connect AI to make your data available for use.
- [Integrations](/en/Integrations)—Steps for connecting integration tools to Connect AI to access data from your data sources.
- [API](/en/API)—Information about connecting to data via the REST API, OData, and OpenAPI protocols.
- [Virtual Databases](/en/Virtual-Databases)—Information about the virtual database feature of Connect AI, including SQL Server.
- [SQL Reference](/en/SQL-Reference)—List of supported SQL syntax and code examples.
