...
All requests to the Connect AI API must be properly authenticated using either OAuth or Basic Authentication. See [Authentication](/en/Authentication) for details.
