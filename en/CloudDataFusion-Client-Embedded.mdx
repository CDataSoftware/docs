...
Before you can configure and use Cloud Data Fusion with Embedded Cloud, you must first connect a data source to your account. See [Sources](/en/Sources-Embedded) for more information.
