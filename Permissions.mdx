...
You can control access to the tables in Connect AI at the source or workspace level.
...
- **Execute:** Enables users to execute stored procedures in a connection.
  ...
  <Frame>
    <img src="/images/connection_permissions.png" alt="Permissions" />
  </Frame>
...
<Frame>
    <img src="/images/user_permissions.png" alt="User Permissions" />
  </Frame>
