...
<Note>
Before you can configure and use ADO.NET with Embedded Cloud, you must first connect a data source to your Embedded Cloud account. See [Sources](/Sources-Embedded) for more information.
</Note>
