...
<Step>
Connect AI **Add Oracle Sales Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とOracle Sales の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/EOM/jp/cloud/default.htm#default)を参照してください。