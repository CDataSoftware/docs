...
<Step>
Connect AI **Add GitHub Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とGitHub の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/FGK/jp/cloud/default.htm#default)を参照してください。