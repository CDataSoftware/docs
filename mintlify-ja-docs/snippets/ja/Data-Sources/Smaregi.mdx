...
<Step>
Connect AI **Add Smaregi Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とSmaregi の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/UXK/jp/cloud/default.htm#default)を参照してください。