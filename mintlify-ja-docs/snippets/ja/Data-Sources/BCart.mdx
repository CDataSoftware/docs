...
<Step>
Connect AI **Add Bcart Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とBcart の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/KGM/jp/cloud/default.htm#default)を参照してください。