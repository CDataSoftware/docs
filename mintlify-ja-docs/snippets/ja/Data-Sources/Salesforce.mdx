...
<Step>
Connect AI **Add Salesforce Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とSalesforce の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/RFK/jp/cloud/default.htm#default)を参照してください。