...
<Step>
Connect AI **Add Redis Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とRedis の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/EIM/jp/cloud/default.htm#default)を参照してください。