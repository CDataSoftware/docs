...
<Step>
OAuth でセキュアに接続するには、**Sign in** をクリックします。これにより、Amazon Athena のサインインページが新しいタブで開かれます。
</Step>
<Step>
Amazon Athena アカウントにログインし、リクエストされた権限を設定します（該当する場合）。
</Step>
<Step>
Amazon Athena で、Connect AI 静的IP アドレスを接続のホワイトリストに追加します。
</Step>
...
Connect AI とAmazon Athena の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/FKK/jp/cloud/default.htm#default)を参照してください。