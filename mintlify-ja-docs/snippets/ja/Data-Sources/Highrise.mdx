...
<Step>
Connect AI **Add Highrise Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とHighrise の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/BHM/jp/cloud/default.htm#default)を参照してください。