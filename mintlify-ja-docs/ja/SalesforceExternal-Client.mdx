...
<Steps>
<Step>
In the **Workspaces** screen in Connect AI, select a workspace and download the OpenAPI specification for the workspace. See [OpenAPI](/ja/OpenAPI) for more information.
<Note>
**Note:** Select OpenAPI version 3.0. Leave **Convert array types to strings** off.
</Note>
</Step>
<Step>
...
<Columns cols={2}>
<Frame>
  <img src="/images/sfl_externalservices.png" alt="Salesforce external services" />
</Frame>
</Columns>
</Step>
<Step>
...
<Frame>
  <img src="/images/sfl_externaloperations.png" alt="Salesforce external operations" />
</Frame>
The input parameters are appended to the URL, such as `$top`, `$filter`, and `$orderby`. See [API Operations](/ja/OpenAPI#api-operations) for a complete parameter reference. The input parameters are based on OData filtering.
...
<Frame>
  <img src="/images/sfl_reviewactions.png" alt="Salesforce review actions" />
</Frame>
</Step>
<Step>
