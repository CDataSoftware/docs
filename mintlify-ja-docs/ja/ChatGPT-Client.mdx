...
Before you can configure and use ChatGPT with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources) for more information.
...
Select **I trust this application**.
	<Frame>
	  <img src="/images/chatgpt_client_connector.png" alt="ChatGPT client connector" />
	</Frame>
</Step>
<Step>
Click **Create**.
...
Click **Add sources** and toggle on the connector you created. The connector appears in the chat session.
	<Frame>
	  <img src="/images/chatgpt_client_developermode.png" alt="ChatGPT client developer mode" />
	</Frame>
</Step>
<Step>
...
Expand **Called tool** to view details about how ChatGPT accesses your data using MCP tools.
	<Frame>
	  <img src="/images/chatgpt_client_calledtool.png" alt="ChatGPT client called tool" />
	</Frame>
</Step>
</Steps>