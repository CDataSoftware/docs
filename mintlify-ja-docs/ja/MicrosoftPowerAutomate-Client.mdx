...
<Frame>
  <img src="/images/powerautomate_client_endpoints.png" alt="Power Automate client endpoints" />
</Frame>
</Step>
<Step>
...
<Columns cols={2}>
<Frame>
  <img src="/images/powerapps_importopenAPI.png" alt="Power Apps import OpenAPI" />
</Frame>
</Columns>
</Step>
<Step>
...
The **3\. Definition** step of the connector defines all the actions of the connector that are contained in the OpenAPI specification file. The actions include all the functions you need for the table, including list, get, create, update, and delete records.
	...
	- **Actions**—each action in the custom connector has **General** information, as well as the **Request**, **Response**, and **Validation** of the response.
		...
		<Frame>
		  <img src="/images/powerapps_request.png" alt="Power Apps request" />
		</Frame>
...
<Frame>
  <img src="/images/powerapps_test.png" alt="Power Apps test" />
</Frame>
</Step>
<Step>
Once the custom connector is created, click the **+** sign to create a connection with the custom connector.
<Frame>
  <img src="/images/powerautomate_client_create_conn.png" alt="Power Automate client create connection" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/images/powerautomate_client_cloud_flow.png" alt="Power Automate client cloud flow" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/images/powerautomate_client_add_action.png" alt="Power Automate client add action" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/images/powerautomate_client_01.png" alt="Power Automate client 01" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/images/powerautomate_client_02.png" alt="Power Automate client 02" />
</Frame>
</Step>
<Step>
...
<Frame>
  <img src="/images/powerapps_create.png" alt="Power Apps create" />
</Frame>
	*Connecting to a workspace*:
<Frame>
  <img src="/images/powerapps_workspace.png" alt="Power Apps workspace" />
</Frame>
</Step>
<Step>
