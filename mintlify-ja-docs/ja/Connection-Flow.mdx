...
<Frame>
<img src="/images/powered_by_cdata_connection_flow.svg" alt="Connection flow diagram" />
</Frame>
...
<Step>
Embedded Cloud calls [Create Connection](/ja/Connection-Management#create-connection).
</Step>
<Step>
