...
api: GET https://cloud.cdata.com/api/poweredby/sources/list
contentType: application/json
---

## List Data Sources

List Data Sources requests a list of data sources supported by Embedded Cloud.

#### Fields

<ResponseField path="dataSource">
  The name to identify the data source.
</ResponseField>
