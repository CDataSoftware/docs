...
description: "このページでは、[OData](/ja/OData-Dashboard) プロトコルを使用してSAP Analytics Cloud をConnect AI に接続する手順の概要を示します。これには、ワークスペースを使う必要があります。詳しくは、[Workspaces](/ja/Workspaces) ヘルプを参照してください。"
---
