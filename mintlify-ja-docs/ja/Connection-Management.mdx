...
|  |  You can obtain data source names from [List Data Sources](/ja/Data-Sources-Management). |
...
| **Name** | **Description** |
| --- | --- |
| connectionId | The connection Id created in [Create Connection](#create-connection). |
