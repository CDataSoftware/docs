...
<Note>
 You can obtain data source names from [List Connections](/ja/List-Connections). If you omit this parameter, the user can select from a list of available data sources.
</Note>
</ParamField>
