---
title: "Authentication for Embedded Cloud"
...
<Step>
 Construct a JSON Claims Set for the JWT with the following parameters.
	...
	| `sub` | The account Id of the child account (optional for [Create Account](/ja/Account-API#create-account) and [List Connections](/ja/List-Connections)). |
