<Note>
**Note:** Before you can configure and use ODBC with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/ja/Sources-Embedded) for more information.
</Note>
