...
<Step>
Connect AI **Add Presto Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とPresto の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/ORK/jp/cloud/default.htm#default)を参照してください。