...
以下の手順で、GraphQL をConnect AI アカウントに接続します。
...
<Step>
検索フィールドに *GraphQL* と入力し、データソース名をクリックします。
</Step>
<Step>
...
<Steps>
<Step>
Enter 認証用のGraphQL ユーザー名 into **User**.
</Step>
<Step>
Enter ユーザーパスワード.
</Step>
<Step>
Connect AI **Add GraphQL Connection** ページ上部の、**Save & Test** をクリックします。
...
<Step>
OAuth でセキュアに接続するには、**Sign in** をクリックします。これにより、GraphQL のサインインページが新しいタブで開かれます。
</Step>
<Step>
GraphQL アカウントにログインし、リクエストされた権限を設定します（該当する場合）。
</Step>
<Step>
Connect AI **Add GraphQL Connection** ページ上部の、**Save & Test** をクリックします。
	- 接続テストに成功すると、コネクションが作成されたことを示す**Connection successfully saved** というメッセージが表示されます。**Edit Connection** ページの**Status** も**Authenticated** に変わります。**Edit Connection** ページの右ペインにある**Data Model** タブで、成功したコネクションのデータモデルを表示します。
...
Connect AI とGraphQL の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/LAK/jp/cloud/default.htm#default)を参照してください。