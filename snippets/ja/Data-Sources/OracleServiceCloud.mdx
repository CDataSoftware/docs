...
<Step>
Connect AI **Add Oracle Service Cloud Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とOracle Service Cloud の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/KOM/jp/cloud/default.htm#default)を参照してください。