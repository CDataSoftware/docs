...
<Steps>
<Step>
In **User** enter 認証用のAmazon DynamoDB ユーザー名.
</Step>
<Step>
...
Connect AI とAmazon DynamoDB の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/DDK/jp/cloud/default.htm#default)を参照してください。