...
<Step>
Connect AI **Add Veeva Vault Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とVeeva Vault の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/SVM/jp/cloud/default.htm#default)を参照してください。