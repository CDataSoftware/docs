...
<Step>
Connect AI **Add MySQL Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とMySQL の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/DMM/jp/cloud/default.htm#default)を参照してください。