...
<Step>
Connect AI **Add Sugar CRM Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とSugar CRM の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/CCK/jp/cloud/default.htm#default)を参照してください。