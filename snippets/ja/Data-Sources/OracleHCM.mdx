...
<Step>
Connect AI **Add Oracle HCM Cloud Connection** ページ上部の、**Save & Test** をクリックします。
...
Connect AI とOracle HCM Cloud の連携の詳細動作については、[こちらのページ](https://cdn.cdata.com/help/KMM/jp/cloud/default.htm#default)を参照してください。