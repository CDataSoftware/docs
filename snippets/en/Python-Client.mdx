<Note>
**Note:** Before you can configure and use Python with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](/en/Sources-Embedded) for more information.
</Note>
