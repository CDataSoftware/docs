...
When creating tables for [API Connector](/en/APIConnector), it is important to remember that each table must be created individually in order to be listed in the Connector's catalog. To do so, follow the steps below:
