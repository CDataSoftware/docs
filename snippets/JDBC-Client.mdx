<Note>
**Note:** Before you can configure and use JDBC with Connect AI, you must first connect a data source to your Connect AI account. See [Sources](https://cloud.cdata.com/docs/Sources.html) for more information.
</Note>
